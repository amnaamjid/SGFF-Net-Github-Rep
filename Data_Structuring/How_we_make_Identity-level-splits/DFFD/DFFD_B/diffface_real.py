...
# ====================================================
image_dir = Path("/home/amna/Ready_to_send_Dataset/DiffFacee/This_is_final_DiffFace/Celeb-HQ-Real-Selected")

output_excel = image_dir.parent / "Celeb_HQ_Real_Selected_Metadata.xlsx"
