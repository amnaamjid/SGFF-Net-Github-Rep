...
# ====================================================
image_dir = Path("/home/amna/Ready_to_send_Dataset/DFFD/DFFDB/This_is_final_DFFD_B_eval_balanced/Real")

output_excel = image_dir.parent / "DFFD_A_Celeb_HQ_Real_Selected_Metadata.xlsx"
